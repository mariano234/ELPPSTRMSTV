  ...
  useEffect(() => {
    const loadContent = async () => {
      ...
      try {
        ...
        if (cachedRaw) {
            ...
            if (parsed.version === CACHE_VERSION && (Date.now() - parsed.timestamp < CACHE_TTL)) {
                if (parsed.items && parsed.items.length > 0) {
                    ...
                    // FIX BUG F5: Asegurar que el random escoge del array correcto
        ...
        // FIX BUG F5: Asegurar random en el fetch
  ...
  return (
    <div className="animate-in fade-in duration-300">
        ...
        <div className="relative h-[65vh] md:h-[85vh] w-full mb-6 md:mb-12 overflow-hidden">
            ...
            {/* CORRECCIÓN MÁRGENES HERO: max-w ajustado en la etiqueta <p> para no rozar la pantalla */}
            <div className="absolute bottom-6 md:bottom-20 left-4 md:left-12 right-0 z-10 flex flex-col justify-end pt-24 pr-4">
                ...
                <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white mb-2 md:mb-4 leading-tight drop-shadow-2xl">
                    {heroItem.displayTitle || heroItem.title}
                </h1>
                <p className="text-gray-300 text-xs sm:text-sm md:text-base lg:text-lg line-clamp-3 font-light mb-4 md:mb-6 max-w-[90%] md:max-w-2xl leading-relaxed">
