...
export default function Navbar({ appLang, setAppLang }) {
  ...
  // Función para resetear todo al pulsar el logo
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-40 transition-all duration-300 ${isScrolled || isMobileSearchOpen ? 'bg-[#141414]/95 backdrop-blur-md shadow-2xl' : 'bg-gradient-to-b from-black/90 via-black/50 to-transparent'}`}>
      <div className="px-4 md:px-12 py-3 flex flex-col gap-3">
        
        <div className="flex items-center justify-between w-full">
           <div className="flex items-center gap-6">
              {/* Logo con función de reset */}
              <div onClick={handleLogoClick} className="flex items-center gap-1 text-[#e5a00d] font-black text-2xl md:text-3xl tracking-tighter shrink-0 cursor-pointer">
        ...
        {/* --- NAVEGACIÓN MÓVIL (Vuelve a estar arriba) --- */}
